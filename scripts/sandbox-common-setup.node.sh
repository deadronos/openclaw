...
INSTALL_RSYNC="${INSTALL_RSYNC:-0}"
INSTALL_TMUX="${INSTALL_TMUX:-0}"
INSTALL_IMAGEMAGICK="${INSTALL_IMAGEMAGICK:-0}"
INSTALL_GHOSTSCRIPT="${INSTALL_GHOSTSCRIPT:-0}"
INSTALL_CONVEX="${INSTALL_CONVEX:-0}"
...
docker build \
  ...
  --build-arg INSTALL_SSH="${INSTALL_SSH}" \
  --build-arg INSTALL_FFMPEG="${INSTALL_FFMPEG}" \
  --build-arg INSTALL_RSYNC="${INSTALL_RSYNC}" \
  --build-arg INSTALL_TMUX="${INSTALL_TMUX}" \
  --build-arg INSTALL_IMAGEMAGICK="${INSTALL_IMAGEMAGICK}" \
  --build-arg INSTALL_GHOSTSCRIPT="${INSTALL_GHOSTSCRIPT}" \
  --build-arg INSTALL_CONVEX="${INSTALL_CONVEX}" \
